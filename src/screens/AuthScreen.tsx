      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.passwordHeader}>
            ...
            {isSignIn && <Pressable onPress={onForgotPassword} hitSlop={8}><Text style={styles.forgot}>Forgot password?</Text></Pressable>}
          </View>
...
const styles = StyleSheet.create({
  keyboard: { flex: 1 }, scroll: { flex: 1 }, container: { paddingHorizontal: 20, paddingTop: 10, paddingBottom: 44 },
  back: { color: '#4F635F', fontSize: 15, fontWeight: '700', marginBottom: 30 },
  brand: { flexDirection: 'row', alignItems: 'center', marginBottom: 28 }, logoCircle: { width: 38, height: 38, borderRadius: 13, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center', marginRight: 10 }, logoMark: { color: '#FFFFFF', fontSize: 20, fontWeight: '900' }, brandName: { color: '#10201D', fontSize: 19, fontWeight: '900' },
  eyebrow: { color: '#0F766E', fontSize: 11, fontWeight: '900', letterSpacing: 1.2, marginBottom: 7 }, title: { fontSize: 29, lineHeight: 36, fontWeight: '800', color: '#10201D' }, subtitle: { fontSize: 14, lineHeight: 21, color: '#6B7D79', marginTop: 10, marginBottom: 20 },
  card: { backgroundColor: '#FFFFFF', borderRadius: 22, padding: 18, borderWidth: 1, borderColor: '#E2EAE8' }, label: { fontSize: 13, fontWeight: '800', color: '#30433F', marginBottom: 8, marginTop: 4 },
  passwordHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, forgot: { color: '#0F766E', fontSize: 12, fontWeight: '800', marginBottom: 8 },
  input: { minHeight: 52, borderWidth: 1, borderColor: '#D6E1DE', borderRadius: 14, paddingHorizontal: 15, fontSize: 16, color: '#10201D', backgroundColor: '#FBFCFC', marginBottom: 12 }, primaryButton: { minHeight: 54, borderRadius: 15, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center', marginTop: 4 }, disabled: { opacity: 0.6 }, primaryButtonText: { color: '#FFFFFF', fontSize: 16, fontWeight: '800' }, hint: { color: '#8A9A96', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 10 },
  message: { padding: 13, borderRadius: 14, marginBottom: 14 }, error: { backgroundColor: '#FFF1F2' }, success: { backgroundColor: '#ECFDF5' }, messageText: { color: '#334155', fontSize: 13, lineHeight: 19 },
});
