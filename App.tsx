...
function AppContent() {
  ...
  useEffect(() => {
    const subscription = BackHandler.addEventListener('hardwareBackPress', () => {
      const previousScreen: Partial<Record<AppScreen, AppScreen>> = { signin:'welcome', signup:'welcome', add: app.addReturnScreen === 'personDetails' ? 'personDetails' : 'dashboard', people:'dashboard', personDetails:'people' };
